...
### Социальная модель
- 🔗 Суперлайки допускаются по depth-circle политике (`K/L`, общий root/anchor)
- 🛡️ Защита от манипуляций через проверку root/anchor/depth в `_isWithinCommunityDistance`
