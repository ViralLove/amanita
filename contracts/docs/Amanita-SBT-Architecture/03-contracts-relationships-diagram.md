...
Документ можно использовать вместе с [01-SBT-ecosystem-and-SpiralEngine-analysis.md](./01-SBT-ecosystem-and-SpiralEngine-analysis.md) для навигации по коду.
