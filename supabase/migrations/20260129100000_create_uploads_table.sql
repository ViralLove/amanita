-- Task: task-implement-upload-flow-core-phase3
-- Table: uploads (Arweave data upload flow; DP-1 Supabase, DP-5 activity_id only, no draft_id)
-- Applied via: supabase/migrations/ or run-migration script from task folder
